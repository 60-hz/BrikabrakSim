...
/* harmony export */   StandaloneElectron: () => (/* binding */ StandaloneElectron)
/* harmony export */ });
class StandaloneElectron
{
    constructor(op)
    {
        this.hello = "world";
...
var __webpack_export_target__ = (STANDALONE = typeof STANDALONE === "undefined" ? {} : STANDALONE);
